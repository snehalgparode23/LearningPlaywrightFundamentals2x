...
await locator.click({ force: true }); // skip actionability checks 3. Hover
...
await page.getByText('Playwright Course').click(); 4. Drag and Drop
...
await page.locator('#droppable').hover();
await page.mouse.up(); 5. Quick Cheat Sheet
Task Code
